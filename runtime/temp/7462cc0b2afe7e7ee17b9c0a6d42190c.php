<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"D:\phpstudy\WWW\Tp5\admin\tp_bs_dms\public/../application/admin\view\layout\base.html";i:1544177823;s:44:"../application/admin/view/layout/header.html";i:1544524001;s:47:"../application/admin/view/layout/left_menu.html";i:1543549291;s:42:"../application/admin/view/layout/main.html";i:1544520856;s:44:"../application/admin/view/layout/footer.html";i:1544595512;}*/ ?>
<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
    ...
    <!--header-->
      ...
      <div class="collapse navbar-collapse bg-theme1-top pl-0" id="navbarToggler">
        ...
        <ul class="navbar-nav" id="module-action">
          ...
          <li class="nav-item pr-2"><a class="nav-link btn text-white" id="more-action" href="#">更多</a></li>
  ...
  <div>
    ...
    <div class="card bg-wihte text-center shadow hide" id="change-theme-card">
      <ul class="list-group list-group-flush">
        <li class="list-group-item p-0"><button class="btn bg-theme1-top text-white w-100" style="border-bottom: 1px solid #ddd;">风格一</button></li>
    ...
    <!--more 更多操作放这里下拉-->
    <div class="card bg-wihte text-center shadow hide" id="more-action-card">
      <ul class="list-group list-group-flush">          
        <li class="list-group-item p-0"><button class="btn text-white w-100 bg-info" id="clear-chache" style="border-bottom: 1px solid #ddd;">清缓存</button></li>
        <li class="list-group-item p-0"><button class="btn text-white w-100 bg-info" id="full-screen">全屏</button></li>
        <li class="list-group-item p-0"><button class="btn text-white w-100 bg-info" id="lock-screen">锁屏</button></li>
      </ul>
    </div>
  </div>
 ...
 <nav class="bg-light p-0" id="tabs-bar">
    ...
    <div class="nav-tab-box h-100">
      <ul class="nav nav-tabs pull-left h-100" id="main-tab">
        ...
        <a class="nav-link p-6 active pull-left content-tab-click" data-toggle="tab" href="javascript:void(0);" role="tab" aria-controls="home" aria-selected="true" open-url="admin/index/home">
          首页
        </a>
        </li>
      </ul>
...
<!--以下标签为固定结构，不要随意更改-->
<!--alert msg 信息提示框-->
<div class="alert alert-dismissible text-center fade shadow hide" id="alert" role="alert">
  <span>message</span>
...
<!--lock screen 锁屏罩-->
<div class="<?php echo $lockScreen; ?>" id="lock-screen-page">
  <div class="card text-center shadow">
      <div class="card-body row">
        <input class="form-control col-8" type="text" name="lock-password" placeholder="请输入密码" autofocus="autofocus">
        <button class="btn btn-sm btn-info col-4" onclick="unlockscreen(this)">解 屏</button>
      </div>
    </div>
</div>
</body>
